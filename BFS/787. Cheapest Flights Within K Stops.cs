...
//思路：BFS 来解决。我们可以从起点城市开始，每一步都探索当前城市的邻接城市，然后记录到每个城市的最小花费。为了限制中转次数，我们可以记录每一步中转的次数，如果次数超过 K，则停止向下探索。在这个过程中，我们需要维护每个城市的最小花费。如果我们发现一个更便宜的价格到达某个城市，我们更新这个城市的最小花费。
